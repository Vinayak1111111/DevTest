...
SECRET_KEY = 'django-insecure-z$jb^-4$2@)9%wsp(6g1p+scf7*1&t^js_#6*2zqkum^jgfe2x'
...
EMAIL_HOST = 'smtp.gmail.com'  # You can change this if you're using another SMTP server
